...
VERSION_NAME     = 'DQN_v03'         # Model/version name for saving models and plots
...
MAX_T            = 800              # Maximum timesteps per episode
...
if __name__ == "__main__":
    ...
    # Load a saved model and play (or continue training).
    load_and_play(20000, learning=False)